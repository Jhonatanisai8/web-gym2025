...
<div class="card">
    <div class="card-body">
        <form method="POST" action="<?= BASE_URL ?>productos/editar/<?= $producto['id'] ?>" class="form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select name="categoria_id" class="form-control" required>
                    <?php foreach ($categorias as $c): ?>
                        <option value="<?= $c['id'] ?>" <?= (($old['categoria_id'] ?? $producto['categoria_id'])==$c['id'])?'selected':'' ?>><?= htmlspecialchars($c['nombre']) ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            ...
            <div class="form-group"><label>Stock</label><input type="number" name="stock" value="<?= htmlspecialchars($old['stock'] ?? '') ?>" class="form-control"></div>
            <div class="form-group"><label>Stock mínimo</label><input type="number" name="stock_minimo" value="<?= htmlspecialchars($old['stock_minimo'] ?? '') ?>" class="form-control"></div>
